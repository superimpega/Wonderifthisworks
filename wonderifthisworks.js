...
function join(user)
{
    API.sendChat("@" + user.username + " Enjoy your stay in the " + Models.room.data.name  + "! Have a Great time =D ");
...
function f_cookie(data) {
        ...
        window.setTimeout(function(){API.sendChat('/me throws a cookie at '+data.from);}, 500);
}
